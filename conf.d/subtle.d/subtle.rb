...
screen 1 do
  top    [ :cpu, :memory, :separator, :temp, :center, :clock, :center, :spacer, :title, :separator, :views ]
  bottom [ ]
end

# Example for a second screen:
screen 2 do
  top    [ :views, :separator, :title, :spacer, :center, :mpd]
  bottom [ ]
end
...
gravity :top66,          [   0,   0, 100,  80 ]
gravity :top33,          [   0,   0, 100,  20 ]


# Top right 9
gravity :top_right,      [  50,   0,  50,  50 ]
gravity :top_right66,    [  75,   0,  25,  33 ]
...
# Bottom left 1
gravity :bottom_left,    [   0,   0,  24, 100 ]

# Bottom 2
gravity :bottom,         [   0,  50, 100,  50 ]
gravity :bottom66,       [   0,  20, 100,  80 ]
gravity :bottom33,       [   0,  80, 100,  20 ]

# Bottom right 3
gravity :bottom_right,   [  75,   0,  25, 100 ]

# Bottom zero 0
gravity :zero_0,  	 [   0,  80,  20,  20 ]
gravity :zero_1,  	 [  20,  80,  20,  20 ]
gravity :zero_2,         [  40,  80,  20,  20 ]
gravity :zero_3,         [  60,  80,  20,  20 ]
gravity :zero_4,         [  80,  80,  20,  20 ]
...
grab "W-KP_7", [ :top_left,     :top_left66	 ]
grab "W-KP_8", [ :top,          :top66,          :top33          ]
grab "W-KP_9", [ :top_right,    :top_right66     ]
grab "W-KP_4", [ :left,         :left66          ]
grab "W-KP_5", [ :center,       :center66,       :center33       ]
grab "W-KP_6", [ :right,        :right66         ]
grab "W-KP_1", [ :bottom_left   ]
grab "W-KP_2", [ :bottom,       :bottom66,       :bottom33]
grab "W-KP_3", [ :bottom_right  ]
grab "W-KP_0", [ :zero_0,	:zero_1,	:zero_2,	:zero_3,	:zero_4		]
...
tag "foo", "evince|libreoffice|thunar|gedit"
tag "bar", "vlc"
tag "gimp", "gimp-2.8"
tag "tex", "texmaker"
tag "game", "warsow|FTL"
